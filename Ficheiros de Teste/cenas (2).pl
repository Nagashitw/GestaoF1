...
remresultado:-nl,consult('resultados.pl'),listing(resultados),write('Numero da Pista: '),read(Id_pista),verifica_resultado_memoria(Id_pista),remover_resultado_memoria(Id_pista).
